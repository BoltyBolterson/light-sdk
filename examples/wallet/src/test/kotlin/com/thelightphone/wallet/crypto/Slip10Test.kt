...
class Slip10Test {
    ...
    fun hardenedChild0() {
        val master = Slip10Ed25519.masterKeyFromSeed(seed)
        val child = Slip10Ed25519.deriveChild(master, index = 0)
    ...
    fun derivePathMatchesSpecVector() {
        ...
        assertEquals("68e0fe46dfb67e368c75379acec591dad19df3cde26e63b93a8e704f1dade7a3", toHex(viaPath.privateKey))
        assertEquals("8b59aa11380b624e81507a27fedda59fea6d0b779a778918a2fd3590e16e9c69", toHex(viaPath.chainCode))
    }
